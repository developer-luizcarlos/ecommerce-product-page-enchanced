...
const Header = () => {
    return (
        <header
            className="flex items-stretch justify-between h-24 w-full border-b-2 border-b-LightGrayishBlue">
            <nav className="flex items-center gap-8">
                ...
                <ul className="h-full flex items-center justify-center gap-5 text-DarkGrayishBlue font-medium">
                    ...
                    <Link
                        href="/men"
                        className="relative h-full flex items-center after:absolute after:-bottom-[1px] after:w-0 after:h-1 after:bg-Orange after:duration-150 after:ease-in-out hover:after:w-full hover:text-VeryDarkBlue">Men</Link>
                    <Link
                        href="/women"
                        className="relative h-full flex items-center after:absolute after:-bottom-[1px] after:w-0 after:h-1 after:bg-Orange after:duration-150 after:ease-in-out hover:after:w-full hover:text-VeryDarkBlue"
                    >Women</Link>
            ...
            <div className="flex items-center gap-5">
                <div className="relative">
                    ...
                    <span
                        className="absolute h-5 w-5 rounded-md flex items-center justify-center -top-4 -right-2 bg-Orange text-sm text-white"
                    >0</span>
                </div>
                <div className="w-12 h-12 overflow-hidden rounded-full border-2 border-transparent cursor-pointer hover:duration-150 hover:ease-in-out hover:border-Orange">
                    <Image src={Avatar} alt="Client profile photo" width={44} height={44} className="object-cover" />
                </div>
            </div>
        </header>
    );
